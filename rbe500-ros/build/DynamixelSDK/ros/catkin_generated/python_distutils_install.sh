...
echo_and_run cd "/home/toner/rbe500-ros/src/DynamixelSDK/ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/toner/rbe500-ros/src/DynamixelSDK/ros/setup.py" \
     \
    build --build-base "/home/toner/rbe500-ros/build/DynamixelSDK/ros" \
    install \
    --root="${DESTDIR-/}" \
